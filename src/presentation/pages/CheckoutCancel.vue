    ...
    <div class="checkout-view">
        ...
        <div class="checkout-right">
            <div class="message">
                ...
                <p class="text-content lead">Tu cuenta no a sido activada a<strong>premium</strong>.</p>
...
const tanksAnimation = new URL('@/assets/anim/buoazul.json', import.meta.url).href
